...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $userData[] = [
            ...
            'login_mail'    => 'manmage1@shop1.com',
            'email'         => 'manmage1@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            'id'            => 4,
            'u_name'        => 'shop1_mange2',
            'f_name'        => 'shop1_mange2_f',
            'l_name'        => 'shop1_mange2_f',
            'login_mail'    => 'shop1_mange2@shop1.com',
            'email'         => 'shop1_mange2@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
            'address'       => 'shop1 mange2 的住所',
            'home_phone'    => '1234567890',
            'mobile_phone'  => '0123456789',
            'birthday'      => '1992/03/22',
            'sex'           => DB_USERS_SEX_MAN,
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop1_common1@shop1.com',
            'email'         => 'shop1_common1@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop1_common2@shop1.com',
            'email'         => 'shop1_common2@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop1_common3@shop1.com',
            'email'         => 'shop1_common3@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop1_common4@shop1.com',
            'email'         => 'shop1_common4@shop1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'manmage1@shop2.com',
            'email'         => 'manmage1@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            'id'            => 11,
            'u_name'        => 'shop2_mange2',
            'f_name'        => 'shop2_mange2_f',
            'l_name'        => 'shop2_mange2_f',
            'login_mail'    => 'shop2_mange2@shop2.com',
            'email'         => 'shop2_mange2@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
            'address'       => 'shop2 mange2 的住所',
            'home_phone'    => '1234567890',
            'mobile_phone'  => '0123456789',
            'birthday'      => '1992/03/22',
            'sex'           => DB_USERS_SEX_MAN,
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop2_common1@shop2.com',
            'email'         => 'shop2_common1@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop2_common2@shop2.com',
            'email'         => 'shop2_common2@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop2_common3@shop2.com',
            'email'         => 'shop2_common3@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'login_mail'    => 'shop2_common4@shop2.com',
            'email'         => 'shop2_common4@shop2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'admin@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'manage1@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'manage2@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common1@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common2@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common3@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common4@produce_company1.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'admin@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'manage1@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'manage2@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common1@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common2@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common3@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
        ...
        $userData[] = [
            ...
            'email'         => 'common4@produce_company2.com',
            'password'      => AuthUtil::encryptPassword('password'),
            'post_code'     => '123-456',
