...
define('DB_GOOD_KINDS_STATUS',      'status');      // 分类信息状态：0:未认证；1；认证
...
define('DB_LOG_LOGINS_USER_ID',         'user_id');         // 登录用户id
define('DB_LOG_LOGINS_LOG_IP',          'log_ip');          // 登录ip信息
define('DB_LOG_LOGINS_LOG_HTTP_INFO',   'log_http_info');   // 登录http信息
define('DB_LOG_LOGINS_STATUS',          'status');          // 登录状态：1:登陆成功，2:密码错误，9:其他
...
define('DB_PREFERENCE_COMMENTS_IS_PUBLIC',      'is_public');           // 是否公开
...
define('DB_PREFERENCES_IS_PUBLIC',          'is_public');       // 是否公开
...
define('DB_PRODUCE_COMPANY_GOODS_IS_PUBLIC',            'is_public');           // 是否公开
...
define('DB_PRODUCE_COMPANYS_STATUS',            'status');              // 厂家状态
...
define('DB_SHOP_COMMENTS_IS_PUBLIC',    'is_public');       // 是否公开
...
define('DB_SHOP_GOODS_IS_PUBLIC',           'is_public');           // 是否公开
define('DB_SHOP_GOODS_STATUS',              'status');              // 商品状态：0:关闭；1:有效：2:等待确认
...
define('DB_SHOPS_STATUS',           'status');              // 商店状态：0:未认证; 1:认证
...
define('DB_USER_RELATIONS_OWNER_ID',                'owner_id');
define('DB_USER_RELATIONS_FRIEND_USER_ID',          'friend_user_id');
define('DB_USER_RELATIONS_STATUS',                  'status');
define('DB_USER_RELATIONS_USER_RELATION_GROUP_ID',  'user_relation_group_id');
...
define('DB_USER_SHARE_COMMENTS_IS_PUBLIC',      'is_public');       // 是否公开
...
define('DB_USER_SHARES_TYPE',           'type');        // 分享类型
define('DB_USER_SHARES_PUBLIC_TYPE',    'public_type'); // 0:公开;1:好友公开;2:注册用户公开;9:所有人公开
...
define('DB_USERS_STATUS',             'status');                // 0: 等待激活; 1:有效; 2:停止;
define('DB_USERS_PUBLIC_TYPE',        'public_type');           // 0:任何人不公开；1:好友公开；2:注册用户公开;9:任意公开
