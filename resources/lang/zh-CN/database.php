...
return [
    ...
    DB_COMMON   => [
        DB_COMMON_ID            => 'id',
        DB_COMMON_CREATED_BY    => '创建者',
        DB_COMMON_UPDATED_BY    => '更新者',
        DB_COMMON_DELETED_BY    => '删除者',
        DB_COMMON_CREATED_AT    => '创建时间',
        DB_COMMON_UPDATED_AT    => '最后更新时间',
        DB_COMMON_DELETED_AT    => '删除时间',
        DB_COMMON_PUBLIC_TYPE   => '公开类型',
        DB_COMMON_VALUE    => [
