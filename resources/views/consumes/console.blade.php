            ...
            <div class="search-word">
                <div class="col-md-10">
                    <div class="search-condition form-inline">
                        ...
                        <span class="consume-time date">
                            <label>{{ trans('pages.consumes.labels.begin_consume_time') }}<input type="text" name="begin_consume_time" class="full-date" value="{{ isset($input['begin_consume_time']) ? $input['begin_consume_time'] : '' }}"></label>
                            <label>{{ trans('pages.consumes.labels.end_consume_time') }}<input type="text" name="end_consume_time" class="full-date" value="{{ isset($input['end_consume_time']) ? $input['end_consume_time'] : '' }}"></label>                            
                        </span>
                        <span>
